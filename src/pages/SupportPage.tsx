           ...
           {supportSections.map((section) => (
             <div key={section.id} className="bg-white rounded-3xl overflow-hidden shadow-xl shadow-slate-200/50 group hover:-translate-y-2 transition-all duration-500 border border-slate-100 flex flex-col">
                ...
                <div className="p-6 border-t border-slate-50">
                   <button className="flex items-center gap-2 text-blue-600 text-[11px] font-black uppercase tracking-widest hover:gap-4 transition-all">
      ...
      <section className="max-w-7xl mx-auto px-6 py-24 space-y-32">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
           <div className="order-2 lg:order-1 space-y-6">
              ...
              <h2 className="text-4xl font-black text-slate-900 leading-tight uppercase tracking-tighter">Yohu Việt Nam: Người đồng hành tin cậy</h2>
        ...
        <div className="bg-slate-900 rounded-[3rem] p-12 md:p-20 relative overflow-hidden">
           ...
           <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-8">
                 <h2 className="text-4xl font-black text-white uppercase leading-tight">Liên hệ trực tiếp bộ phận hỗ trợ</h2>
